...
import { initials, accent } from "@/src/lib/utils";
        ...
        <div style={{ background: "#121214", border: "1px solid #1F2937", borderRadius: 16, padding: 24 }}>
          {step === "id" ? (
            <div>
              ...
              <input
                style={{ width: "100%", background: "#18181B", border: "1px solid #1F2937", borderRadius: 8, padding: "10px 12px", color: "#F9FAFB", fontSize: 14, outline: "none", boxSizing: "border-box", letterSpacing: 2, textTransform: "uppercase" }}
              ...
              <button
                ...
                style={{ width: "100%", marginTop: 16, padding: "11px", background: "#3B82F6", color: "white", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer" }}
              >Continue →</button>
            </div>
          ) : (
            <div>
