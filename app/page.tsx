...
export default function Home() {
  ...
  const [data, setData] = useState({ users: SEED_USERS, teams: SEED_TEAMS, allReports: [] as any[], allLogs: [] as any[], allNoAnswers: [] as any[], goals: [] as any[] });
  ...
  useEffect(() => {
    (async () => {
      ...
      setData({ users: u, teams: t, allReports: r as any[], allLogs: l as any[], allNoAnswers: n as any[], goals: g as any[] });
      setLoading(false);
    })();
  }, []);
