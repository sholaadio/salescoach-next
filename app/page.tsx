...
import { CloserPortal } from "../src/components/portals/CloserPortal";
...
export default function Home() {
  ...
  if (user.role === "closer") return <CloserPortal user={user} allLogs={data.allLogs} onLogSaved={loadData} />;
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#09090B", color:"#F9FAFB", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <p style={{ color:"#4B5563", fontSize:13, marginTop:8 }}>Portal coming soon...</p>
